        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-12">
          ...
          <div>
            <h3 className="text-3xl font-bold mb-4">
              ...
              <span className="text-[#FF4D6D]">integrations</span>
            </h3>
            ...
            <button className="px-6 py-3 border-2 border-[#FF4D6D] text-[#FF4D6D] rounded-full hover:bg-[#FF4D6D] hover:text-white transition">
              Explore Integration
            </button>
          </div>
